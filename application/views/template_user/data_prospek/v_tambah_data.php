          ...
          <div class="container-fluid">
            ...
            <div class="card shadow p-4">
              ...
              <form action="<?= base_url()?>dashboard_users/users/aksi_tambah_data" method="POST">
                <div class="table-responsive">
                  <table class="table table-bordered">
                    <tr>
                      <td style="width: 200px; vertical-align: middle">ID User</td>
                      <td style="width: 40px; vertical-align: middle">:</td>
                      <td><input type="number" class="form-control" name="id_user" value="<?= $this->session->userdata('id_user')?>" readonly/></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td style="width: 40px; vertical-align: middle">:</td>
                      <td><input type="text" class="form-control" name="nama_sales" value="<?= $this->session->userdata('nama_lengkap')?>" readonly/></td>
                    </tr>
                    <tr>
