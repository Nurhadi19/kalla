<div id="wrapper">
      ...
      <ul class="navbar-nav bg-dark sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <li class="nav-item active">
          <a class="nav-link" href="<?= base_url()?>dashboard_admin/admin/">
        ...
        <li class="nav-item">
          ...
          <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              ...
              <a class="collapse-item" href="<?= base_url()?>dashboard_admin/admin/prospek"><i class="fas fa-file mr-2"></i>Prospect Data</a>
            </div>
          </div>
        </li>
        ...
        <li class="nav-item">
          <a class="nav-link collapsed" href="<?= base_url()?>dashboard_admin/admin/report">
            ...
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item dropdown no-arrow">
                ...
                <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                  <a class="dropdown-item" href="<?= base_url('dashboard_admin/profile/')?>">
