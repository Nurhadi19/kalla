...
?>           
          ...
          <div class="container-fluid">
            ...
            <div class="card shadow p-4">
              ...
              <div class="body">
                <form action="<?= base_url()?>dashboard_admin/spk" method="GET">
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <table class="table table-striped table-bordered table-hover" id="prospekTable">
                        ...
                        <?php 
                          ...
                          <tr>
                            ...
                            <td>
                              <a href="<?= base_url('dashboard_admin/spk/edit_spk/'.$data->id_data)?>" class="btn btn-warning btn-sm btn-edit mb-2"> <i class="fas fa-edit"></i> Edit Data </a>
                              <a href="<?= base_url('dashboard_admin/spk/hapus_spk/'.$data->id_data)?>" class="btn btn-danger btn-sm btn-hapus mb-2"> <i class="fas fa-trash"></i> Hapus Data </a>
                            </td>
                          </tr>
